# -*- coding: utf-8 -*-
"""
Code to perform the entire annotation for all test images. This is written according to the IAPR-T12 dataset.
...
'''
Find important topics for each comment document and cluster on the basis of important topics vector obtained
'''
...
'''
for each image document..adaptive thReshold on the topic proportions...then a knn approach 
'''
